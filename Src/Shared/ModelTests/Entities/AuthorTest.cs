...
namespace TPUM.Shared.ModelTests.Entities
{
    public class AuthorTest
    {
        ...
        {
            Assert.Equal(Guid.Parse("EB2E9E9F-C340-4244-BC2D-4B9531AEF2DA"), typeof(Author).GUID);
        }
        ...
        public void EqualsTest()
        {
            string name1 = "Name1";
            string name2 = "Name2";
            List<Book> books1 = new() { new Book() { Id = 1 } };
            List<Book> books2 = new() { new Book() { Id = 2 } };
            Author author11 = new()
            {
                Id = 1,
                FirstName = name1,
        ...
        {
            string name1 = "Name1";
            List<Book> books1 = new() { new Book() { Id = 1, Title = "title1" } };
            Author author1 = new()
            {
                Id = 1,
                FirstName = name1,
