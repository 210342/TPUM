...
namespace TPUM.Shared.DataTests.Formatters
{
    public class JsonFormatterTest
    {
        ...
        public void FormatTest_BaseEntity()
        {
            ...
            Assert.Equal("{\"$id\":\"1\",\"$type\":\"TPUM.Shared.DataTests.TestEntity, DataTests\",\"Id\":1,\"Foo\":\"BarBar\"}", json);
        }
    ...
    ""Foo"": ""Bar""
        ...
        public void FormatTest_DerivedEntity()
        {
            ...
            Assert.NotNull(json);
            Assert.NotEmpty(json);
            Assert.Equal("{\"$id\":\"1\",\"$type\":\"TPUM.Shared.DataTests.DerivedTestEntity, DataTests\",\"Count\":3,\"Id\":1,\"Foo\":\"BarBar\"}", json);
        ...
        [Theory]
        [InlineData("{\"$id\":\"1\",\"$type\":\"TPUM.Shared.DataTests.DerivedTestEntity, DataTests\",\"Id\":0,\"Foo\":\"Bar\",\"Count\":3}")]
        [InlineData("{\"$id\":\"1\",\"$type\":\"TPUM.Shared.DataTests.DerivedTestEntity, DataTests\",\"id\":0,\"foo\":\"Bar\",\"counT\":3}")]
        [InlineData("{\"$id\":\"1\",\"$type\":\"TPUM.Shared.DataTests.DerivedTestEntity, DataTests\",\"Id\": 0, \"Foo\": \"Bar\", \"Count\": 3}")]
        [InlineData(@"{
    ""$id"":""1"",
    ""$type"":""TPUM.Shared.DataTests.DerivedTestEntity, DataTests"",
    ""Id"": 0,
    ""Foo"": ""Bar"",
    ""Count"": 3
}")]
