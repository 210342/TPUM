...
namespace TPUM.Shared.LogicTests.Formatters
{
    public class JsonFormatterTest
    {
        ...
        public void FormatTest_BaseEntity()
        {
            ...
            Assert.Equal("{\"$id\":\"1\",\"$type\":\"TPUM.Shared.LogicTests.TestEntity, LogicTests\",\"Id\":1,\"Foo\":\"BarBar\"}", json);
        }
    ...
    ""Foo"": ""Bar""
        ...
        public void FormatTest_DerivedEntity()
        {
            ...
            Assert.NotNull(json);
            Assert.NotEmpty(json);
            Assert.Equal("{\"$id\":\"1\",\"$type\":\"TPUM.Shared.LogicTests.DerivedTestEntity, LogicTests\",\"Count\":3,\"Id\":1,\"Foo\":\"BarBar\"}", json);
        ...
        [Theory]
        [InlineData("{\"$id\":\"1\",\"$type\":\"TPUM.Shared.LogicTests.DerivedTestEntity, LogicTests\",\"Id\":0,\"Foo\":\"Bar\",\"Count\":3}")]
        [InlineData("{\"$id\":\"1\",\"$type\":\"TPUM.Shared.LogicTests.DerivedTestEntity, LogicTests\",\"id\":0,\"foo\":\"Bar\",\"counT\":3}")]
        [InlineData("{\"$id\":\"1\",\"$type\":\"TPUM.Shared.LogicTests.DerivedTestEntity, LogicTests\",\"Id\": 0, \"Foo\": \"Bar\", \"Count\": 3}")]
        [InlineData(@"{
    ""$id"":""1"",
    ""$type"":""TPUM.Shared.LogicTests.DerivedTestEntity, LogicTests"",
    ""Id"": 0,
    ""Foo"": ""Bar"",
    ""Count"": 3
}")]
